...
public class AudioPrivacy extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		String folderTypePath = "C:\\Users\\SM015\\git\\BGJ_Web\\Podo\\WebContent\\" + id;
		String folderTypePath2 = folderTypePath + "\\" + id + "_" + num;
		String folder = id + "_" + num;
...
//                dto = new BookDTO("용감한포도잼", cnt, folderTypePath + "\\"+ fileName, "", "");
				...
				System.out.println("경경겯ㅇ겨역이ㅏㄹㅇㄴ롱ㄴ리ㅓㅏㅁㄴ오리 : " + folderTypePath2 + "\\" + fileName);
		...
		if (cnt == 0) {
			...
			rd = getServletContext().getRequestDispatcher("/Makesound.jsp?id=" + id + "&title=" + title + "&folder=" + folder);
