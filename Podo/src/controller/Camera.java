...
public class Camera extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		/////////////////////////////////////////////////////////////////////////
		// String folderTypePath = "D:\\voice";
		String folderTypePath = "C:\\Users\\SM025\\git\\BGJ_Web\\Podo\\WebContent\\" + id;
	//	String folderTypePath2 = "C:\\Users\\SM016\\git\\BGJ_Web\\Podo\\WebContent\\" + id + "\\voice";
	...
	//	File Folder2 = new File(folderTypePath2);
		...
		/*
		 * if (!Folder2.exists()) { try { Folder.mkdir(); // 폴더 생성합니다.
		 * System.out.println("폴더가 생성되었습니다."); } catch (Exception e) {
		 * e.getStackTrace(); } } else { System.out.println("이미 폴더가 생성되어 있습니다."); }
		 */
		...
		try {
			...
			if (files.hasMoreElements()) {
				...
				File file2 = new File(folderTypePath + "\\voice.wav");
				file2.delete();
				file.renameTo(new File(folderTypePath + "\\voice.wav"));
